const projects = [
    {
        ...
        descriptionLong: [
            {
                type: "text",
                text: "Avalanche safety has come very far in the past few decades, and one of the main technologies which has proven to be effective has been Avalanche Airbags. " +
            ...
            {
                type: "text",
                text: "As such, my group set out to redesign this trigger system. We ended up taking a two-pronged approach which is also backwards-compatible with the original trigger method. " +
                    ...
                    "After consulting with stakeholders about the design as part of our iterative design methodology, we learned that while our system was more intuitive for new skiers, many older " +
                    "skiers who were already used to the existing system would have a hard time learning anything new. So we made sure our system was backwards-compatible and supported the old method of " +
                    "triggering as a tertiary method."
            },
            {
                type: "text",
                text: "In this project, I took on an informal leadership role within the team, helping to guide group work adn keep the project on track. Additionally, I participated in the iterative design process " +
                    "with my teammates, both providing feedback on their ideas and recommending my own. Finally, I was responsible for writing the Flutter code for our final prototype, and for getting the code published " +
                    "to the Beta Release stage on both the App Store and the Play Store so that people could interact with our app on demo day and try it for themselves."
            }
        ...
        technologies: [
            {
                name: "Arduino",
                use: "An Arduino MKR 1010 wifi board was used to receive data via Bluetooth Low Energy (BLE) from an app, triggering a motor which would open the airbag."
            },
            {
            ...
            {
                name: "Flutter",
                use: "I wrote the UI in Flutter for the iOS/Android app which would allow users to choose a trigger word, and then would listen for said trigger word, triggering the airbag when it hears the word."
            },
            {
                name: "C++",
                use: "All of the code for the Arduino to receive the incoming trigger message and power a motor was written in C++."
            },
            {
                name: "Dart",
    ...
    },
    {
        ...
        descriptionLong: [
            {
                type: "text",
                text: "I worked with four other UofT engineering students to create the website for F!rosh week 2021. My responsibilities included making the React components " +
    ...
    },
    {
        ...
        descriptionLong: [
            {
                type: "text",
                text: "I made an application that handled daily registration, scheduling, and push notifications for F!rosh week 2021. " +
    ...
    },
    {
        ...
        descriptionLong: [
            {
                type: "text",
                text: "To handle the submission of images and videos of tasks during the frosh week scavenger hunt, I worked with the other members of the F!rosh week tech team" +
    ...
    },
    {
        ...
        descriptionLong: [
            {
                type: "text",
                text: "This is the website you are on right now. I wanted a place where I could showcase my various projects and interests, and I also wanted a place " +
    ...
    },
    {
        ...
        descriptionLong: [
            {
                type: "text",
                text: "A civil engineering course (CIV102) project required the class to design a simply supported beam out of Matboard that would span 950mm " +
    ...
    },
    {
        ...
        descriptionLong: [
            {
                type: "text",
                text:"For a two week engineering design project, I constructed a working prototype of a computer 'mouse' that allows a user to control their cursor " +
    ...
    },
    {
        ...
        descriptionLong: [
            {
                type: "text",
                text: "As a personal project starting in the spring of 2020, I developed an app to generate personalized workouts similar to those my coach wrote, with the " +
    ...
    },
    {
        ...
        descriptionLong: [
            {
                type: "text",
                text: "I created the website for UofT Engineering's annual dinner dance, the Cannonball. The website was responsible for giving people information about the event, " +
    ...
    },
    {
        ...
        descriptionLong: [
            {
                type: "text",
                text: "Many charities use Wix sites to interact with their donors and accept donations, however they could not automatically generate Canada Revenue Agency (CRA) compliant " +
    ...
    },
    {
        ...
        descriptionLong: [
            {
                type: "text",
                text: "While working at JMA Consulting, they wanted to transition from using JIRA to Gitlab for project management, however they had hundreds of projects and thousands of issues. " +
    ...
    },
    {
        ...
        descriptionLong: [
            {
                type: "text",
                text: "Autism Ontario wanted an application that would allow for their clients to search for care providers on their phones. This functionality was already available on " +
